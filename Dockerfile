...
''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '//opt//docker', remoteDirectorySDF: false, removePrefix: '', sourceFiles: 'Dockerfile1')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])ctory: '//opt//docker', remoteDirectorySDF: false, removePrefix: '', sourceFiles: 'Dockerfile1')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
    }
 }
